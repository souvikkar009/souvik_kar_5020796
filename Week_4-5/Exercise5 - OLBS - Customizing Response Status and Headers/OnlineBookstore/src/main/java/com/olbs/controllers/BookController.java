...
public class BookController {
	...
	public ResponseEntity<List<Book>> searchBooks(@RequestParam(required = false) String title,
		...
		if (StringUtils.hasText(title) && StringUtils.hasText(author)) {
			...
			return new ResponseEntity<List<Book>>(bookRepository.findByTitleContainingIgnoreCase(title), HttpStatus.OK);
		} else if (StringUtils.hasText(author)) {
			return new ResponseEntity<List<Book>>(bookRepository.findByAuthorContainingIgnoreCase(author),
					HttpStatus.OK);
		} else {
